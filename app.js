...
class SavingsApp {
    ...
    createNewMonth(date) {
        ...
        return {
            ...
            basicExpenses: 0, // Total (auto-calculated from items)
            investments: 0,
    ...
    updateExpenseItem(index, name, amount) {
    ...
    updateBasicExpensesTotal() {
        ...
        this.currentMonth.basicExpenses = total;
    }
